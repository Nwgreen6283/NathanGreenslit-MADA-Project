...
Data
```{r}
vv<- read_csv(file = here("data", "processed_data", "vv_clean_copies_date.csv")) #This file had dates manually added
#sq <-read_csv(here("data", "raw_data", "vv_qPCR_daily_0.csv"))
redo<- read_csv(here("data", "processed_data", "vv_clean_copies_redo_date.csv"))
```
