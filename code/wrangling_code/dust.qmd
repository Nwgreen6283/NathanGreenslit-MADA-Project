...
format:
  html:
    theme: default
---
**This code takes dust concentration data from NRL and cleans it. Steps include, swithcing to the correct timezone, creating concentration sums per day, as well as combining the dust data set with the vibrio enumeration data set.**
Libraries
```{r}
library(tidyverse)
...
Combining Sum and Indifidual df
```{r}
