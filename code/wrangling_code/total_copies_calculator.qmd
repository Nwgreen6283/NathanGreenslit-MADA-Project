...
Some samples did not amplify: Replace NaN with 0 for copies/mL
```{r}
...
Date Column: This adds a date correpsonding the a number in the sample name. 
```{r}
...
Each sample (Date) was done in triplicate for qPCR: We need to take the average of qPCR triplicates 
```{r}
...
Combine Daily and Monthly data sets back togthether. 
```{r}
