...
Each year, plumes of
Saharan dust travel across the Atlantic to be deposited in the surface waters of the Caribbean and Gulf of Mexico. Dust aerosols serve as a significant source of nutrients that can elicit a fertilization effect on marine coastal waters, leading to rapid and potentially harmful blooms (e.g. red tides). Previous work has characterized the response of the marine bacteria *Vibrio* to dust input under the oligotrophic settings of the Florida Keys, but less is (1) quantify *Vibrio* population dynamics and composition, and (2) characterize
potential microbial blooms and community shifts in response to dust input in coastal sites with higher ambient nutrient levels. Monthly and daily sampling influences on microbialpopulations and to capture before, during, and after a Saharan dust event. Culturable *Vibrio* were enumerated as CFU ml^-1^ via spread plating on selective media. qPCRwill be used to estimate total counts of *Vibrio* and of pathogenic *Vibrio* species (*V. cholerae, V. parahaemolyticus, V. vulnificus,* and *V. alginolyticus*) while *Vibrio* composition will be determined using hsp60 gene or 16S rRNA amplicon sequencing. Microbial community composition will be determined using 16S rRNA and 18S rRNA gene amplicon sequencing to examine shifts in prokaryotic and eukaryotic composition over time. This study will provide an increasedunderstanding of the conditions that can elicit potentially harmful blooms, highlighting the need for further research to understand effects of dust
