...
-   My stats code contains some chunks that create predicted values based off of the current data set. Since my data set is small, I am not able to portion of \~25% to use to test my model. Therefore, plotting the predicted vs. actual will give an R2 of 1.00. I am continuing to find a good validation method.
