...
\*need to add details on other environmental variables

<!--# Add detail on other env variables -->
...
![Figure 3: Linear regression models examining the relationship between dust and vibrio growth](images/Screen%20Shot%202023-04-17%20at%2011.21.32%20AM.png)

Above are linear regressions that examine the relationship between dust concentration and copies_mL. As mentioned above, the lags identified may not correspond to the most significant relationship between the two variables.
...
![](images/Screen%20Shot%202023-04-17%20at%203.16.17%20PM.png)

![](images/Screen%20Shot%202023-04-17%20at%203.17.06%20PM.png)

![](images/Screen%20Shot%202023-04-17%20at%203.17.43%20PM.png)
...
Overall, *Vibrio* growth was observed following dust events at both the Gulf and Blind Oso. Peaks in growth were observed 24-48 hours following dust deposition. Linear regression analysis confirmed a correlation between growth and dust input (R2 = 0.49, 0.56, 0.44 for Blind Oso, Canals, and Gulf respectively). However, the environmental dynamics of each site most likely contributed the degree of response per site. Multivariate models were tested using specific environmental parameters: dust, DOM (DON, DOC), temperature, salinity, orthophosphate, and nitrate+nitrite. Ultimately, a model that included water chemistry, dust, nutrient, and dissolved organic matter parameters provided the best performance (R2 = 0.73, 0.7, and 0.76 for Blind Oso, Canals, and Gulf respectively), suggesting that while dust may contribute to a growth response in *Vibrio* following dust input, the site specific dynamics aid in dictating the degree of response observed.
