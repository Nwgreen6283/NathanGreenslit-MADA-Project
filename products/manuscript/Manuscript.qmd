...
CCF plots (found in supplemtary scripts) showed that BO has a significant lag relationship a value of -1. In other words, dust occurs, and one day later, we see a response in *Vibrio* gene copies per mL. C2 has a lag at -2, and RD at -1.
