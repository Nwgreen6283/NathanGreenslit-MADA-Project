...
The Sahara Desert is a significant source of atmospheric dust, eliciting an estimated one billion metric tons each year [@dalmeida1986]. Annually, plumes of this dust travel across the Atlantic via easterly trade winds to be deposited in the surface waters of the Atlantic, Caribbean, and Gulf of Mexico (Fig. 1). These dust events are highly episodic, occurring 3- 4 times a year typically in the summer months and lasting 3-5 days each. Dust aerosols can harbor a wide diversity of bacteria [@kellogg2004], fungi [@ramirez2022], virus-like particles ([Griffin et al., 2001](https://link.springer.com/article/10.1023/A:1011868218901)), and minerals ([Formenti et al., 2003](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2002JD002648)). These aerosols also serve as a significant source of macro and micronutrients such as phosphate, nitrate, and iron ([Graham & Duce, 1967](https://www.sciencedirect.com/science/article/pii/0004698182901986), [Mills et al., 2004](https://pubmed.ncbi.nlm.nih.gov/15152251/), [Savoie et al., 1989](https://agupubs.onlinelibrary.wiley.com/doi/abs/10.1029/JD094iD04p05069?casa_token=PMRaet9QSYsAAAAA:nb8yBorxdKaEWwGfI5aNILJ0D4h6drNu2YY1y1y8ExbQ03z59EUTQTOHoxinzsxRtR4jzsfSA73_Hig)). This addition of otherwise limiting resources can lead to rapid and potentially harmful blooms of certain microbial groups ([Lenes et al., 2008](https://www.sciencedirect.com/science/article/pii/S0278434308000575), [Westrich et al., 2016](https://www.pnas.org/doi/abs/10.1073/pnas.1518080113), [Westrich et al., 2018](https://www.frontiersin.org/articles/10.3389/fmars.2018.00012/full)).
